        ...
        <div className="section" style={{
            ...
            <div className="container" style={{
                ...
                <div className="text-center">
                    <h1 style={{ fontSize: '3.5rem', marginBottom: '30px', color: 'var(--color-primary)' }}>Our Handcraft Story</h1>

                    <h2 style={{ marginBottom: '20px', color: 'var(--color-text)', fontSize: '2rem' }}>Made with Passion</h2>
